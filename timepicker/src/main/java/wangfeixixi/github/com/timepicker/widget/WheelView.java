package wangfeixixi.github.com.timepicker.widget;
...
import wangfeixixi.github.com.timepicker.common.util.ConvertUtils;
import wangfeixixi.github.com.timepicker.common.util.LogUtils;
import wangfeixixi.github.com.timepicker.entity.WheelItem;
...
public class WheelView extends View {
    ...
    public void setTextColor( int colorNormal,  int colorFocus) {
    ...
    public static class DividerConfig {
        ...
        public DividerConfig( float ratio) {
            this.ratio = ratio;
        }
         ...
         * 阴影颜色
         */
        public DividerConfig setShadowColor( int color) {
            shadowVisible = true;
            shadowColor = color;
            return this;
        }
         ...
         * 阴影透明度
         */
        public DividerConfig setShadowAlpha( int alpha) {
         ...
         * 线颜色
         */
        public DividerConfig setColor( int color) {
            this.color = color;
            return this;
        }
         ...
         * 线透明度
         */
        public DividerConfig setAlpha( int alpha) {
            this.alpha = alpha;
            return this;
        }
         ...
         */
        public DividerConfig setRatio( float ratio) {
            this.ratio = ratio;
            return this;
        }
