...
import wangfeixixi.github.com.timepicker.common.popup.ConfirmPopup;
...
public abstract class WheelPicker extends ConfirmPopup<View> {
     ...
     * 设置分隔阴影颜色及透明度
     */
    public void setShadowColor( int color,  int alpha) {
        if (null == dividerConfig) {
            dividerConfig = new WheelView.DividerConfig();
        }
     ...
     * 设置分隔线颜色
     */
    public void setDividerColor( int lineColor) {
        if (null == dividerConfig) {
            dividerConfig = new WheelView.DividerConfig();
        }
